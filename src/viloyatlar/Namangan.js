              ...
              <div className="top-news_big col-12">
                <div className="row">
                  <div className="big-news_img col-6 p-0">
                    <img src="https://storage.kun.uz/source/thumbnails/_medium/7/tPLDyp7CNGcS9MEIxykDYsVwZPEKYvyV_medium.jpg" alt="img" width="480px" height="100%" />
                  </div>
                  <div className="big-news_content col-6 pl-1">
                    <div className="news-text">
                      <span><i class="fas fa-calendar-day"></i> 16:12 / 06.11.2021 </span>
                      <h2>
                        Haqqini talab qilgan yigitni qarzdorning ukasi tiriklay cho‘ktirib qorqitilgan
                      </h2>
          ...
          <div className="col-3 new-title p-0 mt-3 ">
            <div className="row col-12 pl-4">
              <div className="viloyat-img">
                <a href="$"> <span>Namangan ayni damda</span></a>
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/KfPek_32WaW9SEREHD7K12v_lNlAMuct_medium.jpg" alt="rasm" width="300" />
