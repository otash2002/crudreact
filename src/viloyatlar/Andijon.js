              ...
              <div className="top-news_big col-12">
                <div className="row">
                  <div className="big-news_img col-6 p-0">
                    <img src="https://storage.kun.uz/source/thumbnails/_medium/7/kSFSqVwncJhnI10B9PHdziLWwa7GYt2i_medium.jpg" alt="img" width="480px" height="100%" />
                  </div>
          ...
          <div className="col-3 new-title p-0 mt-3 ">
            <div className="row col-12 pl-4">
              <div className="viloyat-img">
                <a href="$"> <span>Andijon ayni damda</span></a>
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/kSFSqVwncJhnI10B9PHdziLWwa7GYt2i_medium.jpg" alt="rasm" width="300" />
