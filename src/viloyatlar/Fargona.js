          ...
          <div className="col-3 new-title p-0 mt-3 ">
            <div className="row col-12 pl-4">
              <div className="viloyat-img">
                <a href="$"> <span>Fargona ayni damda</span></a>
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/V362_rIm53I45s6shOJTzGWTpNc_2cUs_medium.jpg" alt="rasm" width="300" />
