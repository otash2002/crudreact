              ...
              <div className="top-news_big col-12">
                <div className="row">
                  <div className="big-news_img col-6 p-0">
                    <img src="https://storage.kun.uz/source/thumbnails/_medium/7/tb29WWQZhCn5qRK4IfF0IOWehQe_IXbX_medium.jpg" alt="img" width="480px" height="100%" />
                  </div>
          ...
          <div className="col-3 new-title p-0 mt-3 ">
            <div className="row col-12 pl-4">
              <div className="viloyat-img">
                <a href="$"> <span>Navoiy ayni damda</span></a>
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/7gsrNW5FBD_g27NeiCXfd3hEKrnggUe1_medium.jpg" alt="rasm" width="300" />
