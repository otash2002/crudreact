...
export default function Products () {
  return(
    <div classNam="row containere">
      <div className="content containere">
        <h3>
          Recommended products
        </h3>
       <p>Bizni productlarimiz zo`r  aka olsangiz baraka topasiz, eeee ishonavering jovvob vashshe zo`r
        <br /> bunaqasini bozordan topolmaysiz, agar topsangiz tekinga bervoraman</p>
