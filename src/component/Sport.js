...
export default function Sport() {
  return (
    <div className="row containere">
      <div className="col-9 p-0 mt-3 mb-3 sport   ">
        <a href="$" className="firs"><span>SPORT YANGILIKLARI</span></a>
        <div className="top-news">
          <div className="top-news_big col-12">
            <div className="row">
              <div className="big-news_img col-6 p-0">
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/ALhh6-ce2FKn3gVhnAAxZjxl67hRjjLS_medium.jpg " alt="img" width="500px" height="99%" />
              </div>
