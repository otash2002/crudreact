...
export default function Jamiyat() {
  return (
    <div className="row containere">
      <div className="col-9 p-0 mt-3 mb-3 jamiyat">
        <a href="$" className="firs"><span>JAMIYAT YANGILIKLARI</span></a>
        <div className="top-news">
          <div className="top-news_big col-12">
            <div className="row">
              <div className="big-news_img col-6 p-0">
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/SdBb_7rEC0oO_0SeSf-bIrUHWwrjk9R7_medium.jpg" alt="img" width="500px" height="auto" />
              </div>
              <div className="big-news_content col-6">
                <div className="news-text">
                  <span><i class="fas fa-calendar-day"></i> 16:12 / 06.11.2021 </span>
                  <h2>
                    Videoo‘yinlar, strimlar va kibersport - yo‘qotilayotgan bolalik yoki professional kasb
                  </h2>
        ...
        <div className="editor-choice">
          ...
          <div className="row mt-3">
            ...
            <div className="col-4">
              <div className="news">
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/Qm8nfF33RrnIhLUEeVOAWXBgwvOrtG6l_medium.jpg" alt="rasm" width="300" height="203" />
                <span><i class="fas fa-calendar-day"></i> 16:12 / 06.11.2021 </span>
