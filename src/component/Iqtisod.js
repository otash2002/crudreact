...
export default function Iqtisod() {
  return(
    <div className="row containere">
      <div className="col-9 p-0 mt-3 mb-3 iqtisod">
        <a href="$" className="firs"><span>IQTISODIYOT YANGILIKLARI</span></a>
        <div className="top-news">
          <div className="top-news_big col-12">
            <div className="row">
              <div className="big-news_img col-6 p-0">
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/uLH85a7i5ZJETbk5ICyx7gfBOtVTeWVX_medium.jpg" alt="img" width="498px" height="100%  " />
              </div>
