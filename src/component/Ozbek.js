...
export default function Ozbek () {
  return(
    <div className="row containere">
      <div className="col-9 p-0 mt-3 mb-3 ozbek">
      <a href="$" className="firs"><span>O'ZBEKISTON YANGILIKLARI</span></a>
        <div className="top-news">
          <div className="top-news_big col-12">
            <div className="row">
              <div className="big-news_img col-6 p-0">
                <img src="https://storage.kun.uz/source/thumbnails/_medium/7/Spmi9IQeKscdxzbt0Lniwx5c5RFS7HZX_medium.jpg" alt="img" width="500px" height="100%" />
              </div>
